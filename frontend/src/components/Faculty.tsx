...
import { callCreateFaculty, callGetFaculties, callUpdateFaculty } from '../services/faculty';

interface FacultyListProps {
    faculties: IFaculty[];
    updateFaculties: (faculties: IFaculty[]) => void;
}
const FacultyList: React.FC<FacultyListProps> = ({faculties,updateFaculties}) => {
    ...
    const columns: ColumnsType<IFaculty> = [
        ...
        },
        {
            ...
            dataIndex: 'name',
            key: 'name',
            render: (text: string, record: IFaculty) => (
